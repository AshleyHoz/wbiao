$(window).ready(function () {
	...
	$('.menu .toper .right').click(function () {
		...
		// 页面重定向
		window.location.replace("goods-list.html");
	})
	// 点击插入
	// 价格
	$('.menu .middle .price-list li a').click(function() {
		...
		$('.price').html("价格：" + text + '<i class="icon icon-error" title="取消选择"></i>');
	})
	// 品牌
	$('.menu .middle .brand-list li a').click(function() {
		var index = $(this).index();
		var text = $(this).eq(index).text();
		$('.brands').css({
			display: 'inline-block',
		...
		$('.brands').html("品牌：" + text + '<i class="icon icon-error" title="取消选择"></i>');
	})
	// 适用人群
	$('.menu .middle .people-list li a').click(function() {
		var index = $(this).index();
		var text = $(this).eq(index).text();
		$('.peoples').css({
			display: 'inline-block',
		...
		$('.peoples').html("适用人群：" + text + '<i class="icon icon-error" title="取消选择"></i>');
	})
	// 类型
	$('.menu .middle .type-list li a').click(function() {
		var index = $(this).index();
		var text = $(this).eq(index).text();
		$('.types').css({
			display: 'inline-block',
		...
		$('.types').html("机芯类型：" + text + '<i class="icon icon-error" title="取消选择"></i>');
	})
	// 点击移除
